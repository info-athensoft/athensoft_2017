...
<c:set var="speaker_title_3" value="Data Scientist at Faimdata"/>
<c:set var="speaker_desc_3_1" value=""/>
<c:set var="speaker_desc_3_2" value=""/>
<c:set var="speaker_desc_3_3" value=""/>

<c:set var="speaker_name_4" value="Dr. Benoit Palmieri"/>
<c:set var="speaker_title_4" value="VP at strategies and modeling group"/>
							...
							<div class="col-md-4 col-lg-3 mt-3 mb-3">
								<div class="custom-speaker-card background-color-light m-auto">
									...
									<div class="speaker-info speaker-social-gplus p-5">
										...
										<h3 class="text-color-dark custom-font-size-4 font-weight-semibold mb-1">Athens Zhang</h3>
										<p class="custom-font-size-1 mb-0">Co-Founder, CEO of Informatique Athensoft, Software Architect</p>
									</div>
								</div>
							...
							<div class="col-md-4 col-lg-3 mt-3 mb-3">
								<div class="custom-speaker-card background-color-light m-auto">
									...
									<div class="speaker-info speaker-social-facebook p-5">
										...
										<h3 class="text-color-dark custom-font-size-4 font-weight-semibold mb-1">Dr. Cheng Zhang</h3>
										<p class="custom-font-size-1 mb-0">Data Scientist at Faimdata</p>
									</div>
								</div>
						...
						<div class="row justify-content-center">
							<div class="col-10">
								<div class="custom-venue-address background-color-light row">
									<div class="col-md-6 d-none d-md-block p-0" style="background-image: url('/img/demos/event/venue/venue-img.jpg'); background-size: cover;"></div>
