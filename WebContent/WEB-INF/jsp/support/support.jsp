			...
			<div role="main" class="main">
				...
				<section class="page-header">
					<div class="container">
						...
						<div class="row">
							<div class="col">
								<h1><spring:message code="page-title-support"/></h1>
							</div>
						</div>
					</div>
				</section>
					...
					<div class="row justify-content-between">
						...
						<div class="col-lg-3">
							<ul class="nav nav-list flex-column mb-5">
								...
								<li class="nav-item"><a class="nav-link" href="page-team.html">Team</a></li>
								<li class="nav-item"><a class="nav-link" href="page-services.html">Services</a></li>
								<li class="nav-item"><a class="nav-link" href="page-careers.html">Careers</a></li>
								<li class="nav-item"><a class="nav-link" href="page-our-office.html">Our Office</a></li>
								<li class="nav-item"><a class="nav-link" href="page-faq.html">FAQ</a></li>
