...
<c:set var="pageName" value="graphic_imgprocess"/>
<!-- END page variables -->
						...
						<div class="col-lg-3 order-2 order-lg-1">
							<aside class="sidebar">
								...
								<ul class="nav nav-list flex-column mb-4 sort-source">
									...
									<li class="nav-item"><a class="nav-link active" href="${webapp_name}/graphic/service/imgprocess.html?lang=${loc}"><spring:message code="graphic-service-imgprocess"/></a></li> 
										...
										<div class="owl-carousel owl-theme" data-plugin-options="{'items':1}">
											<div>
												<div class="img-thumbnail d-block">
													<img class="img-fluid" src="${img_dir}/graphicservice/big/imgprocess.jpg" alt="design imgprocess">
												</div>
											</div>
										</div>
								</div>
								<div class="post-content">
									<h3><spring:message code="graphic-service-imgprocess"/></h3>
									<p><spring:message code="graphic-service-imgprocess-desc"/></p>
