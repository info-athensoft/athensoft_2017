...
<c:set var="pageName" value="graphic_bizcard"></c:set>
<!-- END page variables -->
						...
						<div class="col-lg-3 order-2 order-lg-1">
							<aside class="sidebar">
								...
								<ul class="nav nav-list flex-column mb-4 sort-source">
									...
									<li class="nav-item"><a class="nav-link active" href="${webapp_name}/graphic/service/bizcard.html?lang=${loc}"><spring:message code="graphic-service-bizcard"/></a></li> 
										...
										<div class="owl-carousel owl-theme" data-plugin-options="{'items':1}">
											<div>
												<div class="img-thumbnail d-block">
													<img class="img-fluid" src="${img_dir}/graphicservice/big/bizcard.jpg" alt="design catalog">
												</div>
											</div>
										</div>
								</div>
								<div class="post-content">
									<h3><spring:message code="graphic-service-bizcard"/></h3>
									<p><spring:message code="graphic-service-bizcard-desc"/></p>
								...
								<div class="row">
									<div class="col-lg-12">
										<ol class="list list-ordened list-ordened-style-3">
											<li><spring:message code="graphic-service-policy-bizcard-1"/></li>
											<li><spring:message code="graphic-service-policy-bizcard-2"/></li>
											<li><spring:message code="graphic-service-policy-bizcard-3"/></li>
											<li><spring:message code="graphic-service-policy-bizcard-4"/></li>
