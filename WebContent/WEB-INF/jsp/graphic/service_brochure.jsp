...
<c:set var="pageName" value="graphic_brochure"></c:set>
<!-- END page variables -->
						...
						<div class="col-lg-3 order-2 order-lg-1">
							<aside class="sidebar">
								...
								<ul class="nav nav-list flex-column mb-4 sort-source">
									...
									<li class="nav-item"><a class="nav-link active" href="${webapp_name}/graphic/service/brochure.html?lang=${loc}"><spring:message code="graphic-service-brochure"/></a></li> 
										...
										<div class="owl-carousel owl-theme" data-plugin-options="{'items':1}">
											<div>
												<div class="img-thumbnail d-block">
													<img class="img-fluid" src="${img_dir}/graphicservice/big/brochure.jpg" alt="design brochure">
												</div>
											</div>
										</div>
								</div>
								<div class="post-content">
									<h3><spring:message code="graphic-service-brochure"/></h3>
									<p><spring:message code="graphic-service-brochure-desc"/></p>
								...
								<div class="col-sm-12">
									<div class="featured-box featured-box-primary text-left mt-3 mt-lg-4">
										<div class="box-content">
											...
											<div class="form-row">
												<label class="col-lg-2 control-label text-lg-right pt-2">
													<spring:message code="graphic-quoteform-fieldname-pagecount"/>
												</label>
												<div class="form-group col-lg-6">
													<input type="text" class="form-control form-control-sm mt-2" id="" placeholder='<spring:message code="graphic-quoteform-placeholder-totalpage"/>'>
												</div>
											</div>
											...
											<div class="form-row">
												...
												<div class="form-group col-lg-3">
													...
													<div class="checkbox">
														<label>
															<input type="checkbox" value="" id="">
															<spring:message code="graphic-quoteform-fieldvalue-crop"/>
														</label>
													</div>
												</div>
											</div>
