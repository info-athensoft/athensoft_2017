...
<c:set var="pageName" value="graphic_smbanner"/>
<!-- END page variables -->
										...
										<div class="owl-carousel owl-theme" data-plugin-options="{'items':1}">
											<div>
												<div class="img-thumbnail d-block">
													<img class="img-fluid" src="${img_dir}/graphicservice/big/smbanner.jpg" alt="design smbanner">
												</div>
											</div>
										</div>
								</div>
								<div class="post-content">
									<h3><spring:message code="graphic-service-smbanner"/></h3>
									<p><spring:message code="graphic-service-smbanner-desc"/></p>
