...
<c:set var="pageName" value="graphic_menu"/>
<!-- END page variables -->
										...
										<div class="owl-carousel owl-theme" data-plugin-options="{'items':1}">
											<div>
												<div class="img-thumbnail d-block">
													<img class="img-fluid" src="${img_dir}/graphicservice/big/menu.jpg" alt="design menu">
												</div>
											</div>
										</div>
								</div>
								<div class="post-content">
									<h3><spring:message code="graphic-service-menu"/></h3>
									<p><spring:message code="graphic-service-menu-desc"/></p>
								...
								<div class="row">
									<div class="col-lg-12">
										<ol class="list list-ordened list-ordened-style-3">
											<li><spring:message code="graphic-service-policy-menu-1"/></li>
											<li><spring:message code="graphic-service-policy-menu-2"/></li>
											<li><spring:message code="graphic-service-policy-menu-3"/></li>
