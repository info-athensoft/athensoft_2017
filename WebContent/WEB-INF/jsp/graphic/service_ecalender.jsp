...
<c:set var="pageName" value="graphic_ecalender"></c:set>
<!-- END page variables -->
						...
						<div class="col-lg-3 order-2 order-lg-1">
							<aside class="sidebar">
								...
								<ul class="nav nav-list flex-column mb-4 sort-source">
									...
									<li class="nav-item"><a class="nav-link active" href="${webapp_name}/graphic/service/ecalender.html?lang=${loc}"><spring:message code="graphic-service-ecalender"/></a></li> 
								</ul>
										...
										<div class="owl-carousel owl-theme" data-plugin-options="{'items':1}">
											<div>
												<div class="img-thumbnail d-block">
													<img class="img-fluid" src="${img_dir}/graphicservice/big/ecalendar.jpg" alt="design ecalender">
												</div>
											</div>
										</div>
								</div>
								<div class="post-content">
									<h3><spring:message code="graphic-service-ecalender"/></h3>
									<p><spring:message code="graphic-service-ecalender-desc"/></p>
								...
								<div class="col-sm-12">
									<div class="featured-box featured-box-primary text-left mt-3 mt-lg-4">
										<div class="box-content">
											<div class="form-row">
												<label class="col-lg-2 control-label text-lg-right pt-2">主题</label>
												<div class="form-group col-lg-6">
													<input type="text" value="不限" class="form-control form-control-sm mt-2" id="qtyWebpage">
												</div>
											</div>
											...
											<div class="form-row">
												...
												<div class="form-group col-lg-6">
													<input type="text" class="form-control form-control-sm mt-2" id="qtyImage" placeholder="可输入多个">
												</div>
											</div>
											
											<div class="form-row">
												<label class="col-lg-2 control-label text-lg-right pt-2">字体</label>
												<div class="form-group col-lg-6">
