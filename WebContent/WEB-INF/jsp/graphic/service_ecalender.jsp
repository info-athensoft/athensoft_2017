										...
										<div class="box-content">
											<div class="form-row">
												<label class="col-lg-2 control-label text-lg-right pt-2">
													<spring:message code="graphic-quoteform-fieldname-subject"/>
												</label>
												<div class="form-group col-lg-6">
													<input type="text" class="form-control form-control-sm mt-2" id="" placeholder='<spring:message code="graphic-quoteform-placeholder-subject"/>'/>
												</div>
											</div>
