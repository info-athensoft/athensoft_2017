					...
					<div class="row">
						<div class="col-lg-4 order-2 order-lg-1">
							<aside class="sidebar">
								...
								<a class="btn btn-primary mb-2" href="https://goo.gl/forms/WiPrE1DrlEluffu62" target="_blank">Register now</a><br/>
								...
								<ul class="nav nav-list flex-column mb-4 sort-source">
									<li class="nav-item"><a class="nav-link active" href="#"><spring:message code="webdev-sidebar-link-1"/></a></li>
									...
									<li class="nav-item"><a class="nav-link" href="${webapp_name}/webdev/support.html?lang=${loc}" target="_blank"><spring:message code="webdev-sidebar-link-4"/></a></li>
						...
						<div class="col-lg-8 order-1 order-lg-2">
							...
							<h4><spring:message code="ceit-1101-course-code"/>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary btn-sm mb-2" href="https://goo.gl/forms/WiPrE1DrlEluffu62" target="_blank">Register now</a><br/></h4>
							<div class="row">
								<div class="col">
