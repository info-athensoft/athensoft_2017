		...
		<div class="body">
			...
			<div role="main" class="main">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col">
							<h4 class="mt-5 mb-0 text-uppercase"><strong>STEM 1101 青少年软件开发</strong></h4>
							<p></p>
							...
							<ul class="row portfolio-list">
								<li class="col-12 col-sm-6 col-lg-3">
									<div class="portfolio-item">
										...
										<div class="thumb-info-title my-align-center">
											<span class="thumb-info-type my-item-title">Thomas Cao</span><br/>
											<span class="thumb-info-type my-item-title">佳程教育</span><br/>
											<!-- <span class="thumb-info-inner">${level_course}</span><br/>  -->
											<a href="${webapp_name}/learning/stuwork/thomas?lang=${loc}"  target="_blank" class="btn btn-primary btn-sm">
											View</a>
										</div>
									</div>
								</li>
								...
								<li class="col-12 col-sm-6 col-lg-3">
									<div class="portfolio-item">
										...
										<div class="thumb-info-title my-align-center">
											<span class="thumb-info-type my-item-title">Bowen Zhang</span><br/>
											<span class="thumb-info-type my-item-title">佳程教育</span><br/>
											<!-- <span class="thumb-info-inner">${level_course}</span><br/>  -->
											<a href="${webapp_name}/learning/stuwork/bowen?lang=${loc}"  target="_blank" class="btn btn-primary btn-sm">
											View</a>
										</div>
									</div>
								</li>
								...
								<li class="col-12 col-sm-6 col-lg-3">
									<div class="portfolio-item">
										...
										<div class="thumb-info-title my-align-center">
											<span class="thumb-info-type my-item-title">Yuzhe Shi</span><br/>
											<span class="thumb-info-type my-item-title">佳程教育</span><br/>
											<!-- <span class="thumb-info-inner">${level_course}</span><br/>  -->
											<a href="${webapp_name}/learning/stuwork/yuzhe?lang=${loc}"  target="_blank" class="btn btn-primary btn-sm">
											View</a>
										</div>
									</div>
								</li>
								...
								<li class="col-12 col-sm-6 col-lg-3">
									<div class="portfolio-item">
										...
										<div class="thumb-info-title my-align-center">
											<span class="thumb-info-type my-item-title">Yuchen Shi</span><br/>
											<span class="thumb-info-type my-item-title">佳程教育</span><br/>
											<!-- <span class="thumb-info-inner">${level_course}</span><br/>  -->
											<a href="${webapp_name}/learning/stuwork/yuchen?lang=${loc}"  target="_blank" class="btn btn-primary btn-sm">
											View</a>
										</div>
									</div>
								</li>
								...
								<li class="col-12 col-sm-6 col-lg-3">
									<div class="portfolio-item">
										...
										<div class="thumb-info-title my-align-center">
											<span class="thumb-info-type my-item-title">Ryan Bai</span><br/>
											<span class="thumb-info-type my-item-title">佳程教育</span><br/>
											<!-- <span class="thumb-info-inner">${level_course}</span><br/>  -->
											<a href="${webapp_name}/learning/stuwork/bai?lang=${loc}"  target="_blank" class="btn btn-primary btn-sm">
											View</a>
										</div>
									</div>
								</li>
								...
								<li class="col-12 col-sm-6 col-lg-3">
									<div class="portfolio-item">
										...
										<div class="thumb-info-title my-align-center">
											<span class="thumb-info-type my-item-title">William</span><br/>
											<span class="thumb-info-type my-item-title">佳程教育</span><br/>
											<!-- <span class="thumb-info-inner">${level_course}</span><br/>  -->
											<a href="${webapp_name}/learning/stuwork/william?lang=${loc}"  target="_blank" class="btn btn-primary btn-sm">
											View</a>
										</div>
									</div>
								</li>
