	...
	<div
		...
		<nav class="collapse">
			<ul class="nav nav-pills" id="mainNav">
				...
				<li class=""><a class="nav-link" href="demos.html"> Demos </a>
				</li>
