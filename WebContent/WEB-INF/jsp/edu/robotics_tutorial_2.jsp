				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-9 order-1 order-lg-2">
							...
							<!-- tutorials -->
							<h3><spring:message code="robotics-title-5"/> 2 - Mindstorms EV3 Tutorial</h3>
								...
								<div class="col-lg-7">
									<article class="">
										<div>
											...
											<label>Kevin Briggs, Published on Aug 28, 2015</label>
											<p></p>
										</div> 
									</article>
								</div>
							...
							<div class="row">
								<div class="col-lg-5">
									<article class="">
										<div class="post-video">
											<iframe width="854" height="480" src="https://www.youtube.com/embed/1dZNr5eFeLA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
										</div>
									</article>
								</div>
								...
								<div class="col-lg-7">
									<article class="">
										<div>
											<label><strong>Mindstorms EV3 Tutorial #2: Drive in a square using a loop block</strong></label>
											<label>Kevin Briggs, Published on Aug 28, 2015</label>
											<p></p>
										</div> 
									</article>
							...
							<div class="row">
								<div class="col-lg-5">
									<article class="">
										<div class="post-video">
											<iframe width="854" height="480" src="https://www.youtube.com/embed/DsxoIAB-sYk" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
										</div>
									</article>
								</div>
								...
								<div class="col-lg-7">
									<article class="">
										<div>
											<label><strong>Mindstorms EV3 Tutorial #3: Using the touch sensor</strong></label>
											<label>Kevin Briggs, Published on Aug 29, 2015</label>
											<p></p>
										</div> 
									</article>
								</div>
							...
							<div class="row">
								<div class="col-lg-5">
									<article class="">
										<div class="post-video">
											<iframe width="854" height="480" src="https://www.youtube.com/embed/swhoJ2MpJyY" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
										</div>
									</article>
								</div>
								...
								<div class="col-lg-7">
									<article class="">
										<div>
											<label><strong>Mindstorms EV3 Tutorial #4: Turn your EV3 into a musical instrument</strong></label>
											<label>Kevin Briggs, Published on Sep 26, 2015</label>
											<p></p>
										</div> 
									</article>
								</div>
							...
							<div class="row">
								<div class="col-lg-5">
									<article class="">
										<div class="post-video">
											<iframe width="854" height="480" src="https://www.youtube.com/embed/W4has2MySCs" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
										</div>
									</article>
								</div>
								...
								<div class="col-lg-7">
									<article class="">
										<div>
											<label><strong>Mindstorms EV3 Tutorial #5: Use the ultrasonic sensor to follow a wall</strong></label>
											<label>Kevin Briggs, Published on Oct 1, 2015</label>
											<p></p>
										</div> 
									</article>
								</div>
							...
							<div class="row">
								<div class="col-lg-5">
									<article class="">
										<div class="post-video">
											<iframe width="854" height="480" src="https://www.youtube.com/embed/ye3MhVA9Rhs" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
										</div>
									</article>
								</div>
								...
								<div class="col-lg-7">
									<article class="">
										<div>
											<label><strong>Mindstorms EV3 Tutorial #6: Use the color sensor to follow a line</strong></label>
											<label>Kevin Briggs, Published on Oct 29, 2015</label>
											<p></p>
										</div> 
									</article>
								</div>
							...
							<div class="row">
								<div class="col-lg-5">
									<article class="">
										<div class="post-video">
											<iframe width="854" height="480" src="https://www.youtube.com/embed/CBzUYdzsOQA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
										</div>
									</article>
								</div>
								...
								<div class="col-lg-7">
									<article class="">
										<div>
											<label><strong>Mindstorms EV3 Tutorial #7: Use the gyro sensor</strong></label>
											<label>Kevin Briggs, Published on Nov 10, 2015</label>
											<p></p>
										</div> 
									</article>
								</div>
							...
							<div class="row">
								<div class="col-lg-5">
									<article class="">
										<div class="post-video">
											<iframe width="854" height="480" src="https://www.youtube.com/embed/RdW5NQUvWnA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
										</div>
									</article>
								</div>
								...
								<div class="col-lg-7">
									<article class="">
										<div>
											<label><strong>Mindstorms EV3 Tutorial #8: Reading and Writing Files</strong></label>
											<label>Kevin Briggs, Published on Feb 24, 2016</label>
											<p></p>
										</div> 
									</article>
								</div>
