...
<html>
	<head>
		...
		<meta name="keywords" content="<spring:message code='seo-keywords-webcustom'/>" />
		<meta name="description" content="<spring:message code='seo-desc-webcustom'/>">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-3 order-2 order-lg-1">
							<aside class="sidebar">
								...
								<ul class="nav nav-list flex-column mb-4 sort-source">
									...
									<li class="nav-item"><a class="nav-link active" href="#"><spring:message code="webdev-sidebar-link-3"/></a></li>
						...
						<div class="col-lg-9 order-1 order-lg-2">
							...
							<!-- overview -->
							<h3><spring:message code="webdev-webcustom-title-1-1"/></h3>
							<div class="row">
								<div class="col">
									<p class="">
										<spring:message code="webdev-webcustom-content-1-1"/>
									</p>
								</div>
							</div>
									...
									<div class="toggle toggle-primary" data-plugin-toggle>
											<section class="toggle">
												...
												<div class="toggle-content">
													<p><spring:message code="webdev-webcustom-2-1_1b"/></p>
												</div>
											</section>
											<section class="toggle">
												<label><spring:message code="webdev-webcustom-2-1_2a"/></label>
												<div class="toggle-content">
													<p><spring:message code="webdev-webcustom-2-1_2b"/></p>
												</div>
											</section>
											<section class="toggle">
												<label><spring:message code="webdev-webcustom-2-1_3a"/></label>
												<div class="toggle-content">
													<p><spring:message code="webdev-webcustom-2-1_3b"/></p>
												</div>
											</section>
											<section class="toggle">
												<label><spring:message code="webdev-webcustom-2-1_4a"/></label>
												<div class="toggle-content">
													<p><spring:message code="webdev-webcustom-2-1_4b"/></p>
												</div>
											</section>
											<section class="toggle">
												<label><spring:message code="webdev-webcustom-2-1_5a"/></label>
												<div class="toggle-content">
													<p><spring:message code="webdev-webcustom-2-1_5b"/></p>
												</div>
											</section>
											<section class="toggle">
												<label><spring:message code="webdev-webcustom-2-1_6a"/></label>
												<div class="toggle-content">
													<p><spring:message code="webdev-webcustom-2-1_6b"/></p>
												</div>
											</section>
											<section class="toggle">
												<label><spring:message code="webdev-webcustom-2-1_7a"/></label>
												<div class="toggle-content">
													<p><spring:message code="webdev-webcustom-2-1_7b"/></p>
												</div>
											</section>
										</div>
								</div>
